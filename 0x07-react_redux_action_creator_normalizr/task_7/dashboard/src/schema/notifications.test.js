...
describe('Test for notifications.js', () => {
  it('verify that the function returns a list containing all the context objects from the notifications.json data when the author id is the same as the userId', () => {
    const result = [
      {
  ...
  it('should match expected array', () => {
    ...
    expect(normalized.result).toEqual(expectedArray);
  });
  ...
  it('should have a correct messages entity', () => {
    ...
    expect(
      normalized.entities.messages['efb6c485-00f7-4fdf-97cc-5e12d14d6c4'],
    ).toEqual(message);
  });
